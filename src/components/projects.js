                ...
                <div className = "projects-grid-work">
                    <Container fluid>
                        ...
                        <Col xs={12} md = {6} lg={6} style={{marginBottom: '4em'}}>
                            <Card shadow={5} style ={{minWidth: '450', margin: 'auto'}}>
                                <CardTitle style={{color: '#000', height: '176px', background: '<h1>hello</h1> center / cover'}}>
