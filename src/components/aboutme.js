            ...
            <div className = "aboutme-grid-div">
                <Grid className = "aboutme-grid">
                    ...
                    <Cell col={4}>
                        ...
                        <p></p>
                        <p>Hi! I'm <strong>Ryan Tan</strong> and thank you for visiting my website. I spent the Easter break building this website, and after spending countless of hours styling, thinking about what content to put up and learning how to deploy to my own custom domain, I can finally say that I've managed to finish my list of must-haves. 
                        I'm still currently building this website, so if you have any interesting ideas on making my website feel a little more unique, please shoot me a message! You can find my contact details on my resume or <a href="http://www.linkedin.com/in/rtan18" rel="noopener noreferrer" target="_blank">LinkedIn</a>, as they are not shared here due to scrape bots. </p>
